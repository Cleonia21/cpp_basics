...
ClapTrap::ClapTrap()
{
	std::cout << "Deafault constructor " << this->_name << " colled" << std::endl;
	this->_health = 10;
	this->_energy = 10;
	this->_damage = 0;
}
...
{
	std::cout << "Name constructor " << this->_name << " colled" << std::endl;
	this->_name = name;
	this->_health = 10;
	this->_energy = 10;
	this->_damage = 0;
...
{
	std::cout << "Copy constructor " << this->_name << " colled" << std::endl;
...
{
	std::cout << "Assignement " << this->_name << " operator called" << std::endl;
